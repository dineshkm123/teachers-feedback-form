...
//        Choice ic14 = new Choice();
        ...
        sub.add("DAA"); sub.add("MES"); sub.add("OS"); sub.add(""); sub.add("");
...
//                    out.write("\n".getBytes());
                ...
                String subject = sub.getItem(sub.getSelectedIndex());
                String ec1Choice = ec1.getItem(ec1.getSelectedIndex());
                String ec2Choice = ec2.getItem(ec2.getSelectedIndex());
                String ec3Choice = ec3.getItem(ec3.getSelectedIndex());
                String ec4Choice = ec4.getItem(ec4.getSelectedIndex());
                String ec5Choice = ec5.getItem(ec5.getSelectedIndex());
                String ec6Choice = ec6.getItem(ec6.getSelectedIndex());
                String ec7Choice = ec7.getItem(ec7.getSelectedIndex());
                String ec8Choice = ec8.getItem(ec8.getSelectedIndex());
                String ec9Choice = ec9.getItem(ec9.getSelectedIndex());
                String ec10Choice = ec10.getItem(ec10.getSelectedIndex());
                String ec11Choice = ec11.getItem(ec11.getSelectedIndex());
                String ec12Choice = ec12.getItem(ec12.getSelectedIndex());
                String ec13Choice = ec13.getItem(ec13.getSelectedIndex());
                String ec14Choice = ec14.getItem(ec14.getSelectedIndex());

                // Add more choices as needed

                // Display the selected choices in the console
                System.out.println("Subject: " + subject);
                System.out.println("Teacher is prepared for class: " + ec1Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec2Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec3Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec4Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec5Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec6Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec7Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec8Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec9Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec10Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec11Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec12Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec13Choice);
                System.out.println("Teacher knows His/Her Subject: " + ec14Choice);


                // Add more print statements for other choices as needed

                // Show a message dialog with the selected choices
                String message = "Subject: " + subject + "\n"
                        + "Teacher is prepared for class: " + ec1Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec2Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec3Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec4Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec5Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec6Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec7Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec8Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec9Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec10Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec11Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec12Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec13Choice + "\n"
                        + "Teacher knows His/Her Subject: " + ec14Choice + "\n"
                        ;
                // Add more choices to the message as needed
                JOptionPane.showMessageDialog(First.this, message, "Selected Choices", JOptionPane.INFORMATION_MESSAGE);
            }
